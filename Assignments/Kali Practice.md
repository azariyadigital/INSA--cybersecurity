...
.chmod 777 → rwxrwxrwx (everyone: all)  ➡ the dangerous one 
...
0      available 	SSH login 	ssh bandit0@bandit.labs.overthewire.org -p 2220
0→1    available	Read a file 	cat readme
...
➡  Assignment 6 — Vim Editor Practice
 ...
 Vim is always available on servers.
